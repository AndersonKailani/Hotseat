...
faceButton.addEventListener('mousemove', function(e) {
  ...
  TweenMax.to(faceButton, 0.3, {
     x: (mouseX - mouseCoords.width / 2) / mouseCoords.width * 300,
     y: (mouseY - mouseCoords.height / 2) / mouseCoords.width * 300,
     ease: Power4.easeOut
   })
});
...
faceButton.addEventListener('click', function() {
    window.location.href = 'index.html'; // Replace with the path to your index file if different
  });